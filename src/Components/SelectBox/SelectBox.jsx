...
export default function SelectBox({ person1, person2 , person3}) {
  ...
  const handleInformation = (event) => {
    ...
    }else if (selectedValue === person3.pName) {
      setSelectedPerson(person3);
    }
  }
        ...
        <div className="selectBox">
          ...
          <label>
            <input
              ...
              name="option"
              value={person3.pName}
              checked={selectedPerson.pName === person3.pName}
              onChange={handleInformation}
            />
            {person3.pName}
          </label>
